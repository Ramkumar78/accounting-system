-- Initial Data Setup for Accounting System (MySQL Compatible)
...
INSERT IGNORE INTO users (id, username, password, email, full_name, role_id, enabled, created_at) VALUES
...
-- Currencies
INSERT IGNORE INTO currencies (id, code, name, symbol, exchange_rate, is_base) VALUES
...
-- Assets (1000-1999)
INSERT IGNORE INTO accounts (id, code, name, account_type, description, is_active) VALUES
...
-- Fiscal Years
INSERT IGNORE INTO fiscal_years (id, name, start_date, end_date, is_closed) VALUES
